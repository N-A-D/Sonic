...
void sonic::util::rectangle::set_width(int val)
{
	w = val;
}

void sonic::util::rectangle::set_height(int val)
{
	h = val;
}

void sonic::util::rectangle::set_center(int x, int y)
{
	this->x = x - w / 2;
	this->y = y - h / 2;
}

void sonic::util::rectangle::set_top_left(int x, int y)
{
	this->x = x;
	this->y = y;
}

void sonic::util::rectangle::set_top_mid(int x, int y)
{
	this->x = x - w / 2;
	this->y = y;
}

void sonic::util::rectangle::set_top_right(int x, int y)
{
	this->x = x - w;
	this->y = y;
}

void sonic::util::rectangle::set_mid_right(int x, int y)
{
	this->x = x - w;
	this->y = y - h / 2;
}

void sonic::util::rectangle::set_btm_right(int x, int y)
{
	this->x = x - w;
	this->y = y - h;
}

void sonic::util::rectangle::set_btm_mid(int x, int y)
{
	this->x = x - w / 2;
	this->y = y - h;
}

void sonic::util::rectangle::set_btm_left(int x, int y)
{
	this->x = x;
	this->y = y - h;
}

void sonic::util::rectangle::set_mid_left(int x, int y)
{
	this->x = x;
	this->y = y - h / 2;
}
